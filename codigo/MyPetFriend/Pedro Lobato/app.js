    ...
    for (let i=0; i < db.pets.length; i++) {
        ...
        <div class="Sep">
            ...
            <div class="card-body">
                ...
                <p class="card-text">${pet.estado}, ${pet.cidade} </p>
                <p class="card-text">${pet.raca}, ${pet.porte} </p>
            </div>

            <ul class="list-group list-group-flush">
                <li class="list-group-item"><a href="#" class="card-link"> <a href="index.html?id=${pet.id}"> Página do animal</a> </a></li>
            </ul>       
            </div>
        </div>
...
// ${pet.nome} Variavel de nome do pet ->
